...
Десктопная сборка для Windows — **отдельный** релиз (`windows-v…`), не смешивается с автоматическими `build-N`. Актуальная версия сейчас: [windows-v0.1.10](https://github.com/5451165-bot/PDF-Manager/releases/tag/windows-v0.1.10).
